...
#' Displacement of the vehicles from west
#'
#' This procedure is used inside the procedures;
#' move_bicycle()
#' move_bike()
#' move_car()
#' move_truck()
#' it indicate the vehicle coming from the west and it shows it current position.
#'  this procedure is not accessible by the public
#' this procedure is automatically call once the simulation of a particular vehicle is lunched.
#'
#' @param i,x,y i is the timing of the overall simulation, x,y correspond
...
from_west <- function(i, x, y){
  ...
  points(x[200-i], y[105],pch=10, col="red", cex=2)
...
#' take once it reaches the junction. The acceptable input are; "EAST", "WEST", "NORTH", "SOUTH"
#'
#' @return No return value
#' @export
move_bicycle <- function(simulation_time, direction_from, direction_to){
  ...
  direction <- c("EAST", "WEST", "NORTH", "SOUTH")
    ...
    for(i in 1:simulation_time){
      ...
      if(direction_to == "WEST"){
        ...
        if(i<90){
          ...
          light_color_green_left(x,y)
          points(x[i-56], y[100],pch=10, col="red", cex=2)
        }
      }
    ...
    for(i in 1:simulation_time){
      ...
      if(direction_to == "EAST"){
        ...
        if(i<80){
          ...
          light_color_red_left(x,y)
          points(x[120], y[105],pch=10, col="red", cex=2)
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[140-(i-120)], y[105],pch=10, col="red", cex=2)
        }
      }
      ...
      if(direction_to == "WEST"){
        ...
        if(i<80){
          ...
          light_color_green_left(x,y)
          points(x[i-20], y[100],pch=10, col="red", cex=2)
        }
      }
      ...
      if(direction_to == "NORTH"){
        ...
        if(i<90){
          ...
          light_color_red_left(x,y)
          points(x[105], y[i+14 ],pch=10, col="red", cex=2)
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[105], y[i+14 ],pch=10, col="red", cex=2)
      ...
      if(direction_to == "SOUTH"){
        ...
        if(i<85){
         from_west(i,x,y)
          ...
          light_color_red_left(x,y)
          points(x[115], y[105],pch=10, col="red", cex=2)
        }else if(i>140){
          light_color_green_left(x,y)
          if(i<=145){
            points(x[250-i], y[105],pch=10, col="red", cex=2)
          }else{
            points(x[100], y[250-i],pch=10, col="red", cex=2)
          }
        }
      }
    ...
    for(i in 1:simulation_time){
      ...
      if(direction_to == "WEST"){
        ...
        if(i<90){
          ...
          light_color_red_left(x,y)
          points(x[i+10], y[100],pch=10, col="red", cex=2)
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[i+10], y[100 ],pch=10, col="red", cex=2)
      ...
      if(direction_to == "WEST"){
        ...
        if(i<90){
          ...
          if(i<=100){
            ...
            points(x[i+4], y[100],pch=10, col="red", cex=2)
          }
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[i+4], y[100],pch=10, col="red", cex=2)
    ...
    for(i in 1:simulation_time){
      ...
      if(direction_to == "WEST"){
        ...
        if(i<90){
          ...
          light_color_green_left(x,y)
          points(x[i-56], y[100],pch=16, col="red", cex=2)
        }
      }
    ...
    for(i in 1:simulation_time){
      ...
      if(direction_to == "EAST"){
        ...
        if(i<80){
          ...
          light_color_red_left(x,y)
          points(x[120], y[105],pch=16, col="red", cex=2)
          Sys.sleep(0.3)
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[140-(i-120)], y[105],pch=16, col="red", cex=2)
        }
      }
      ...
      if(direction_to == "WEST"){
        ...
        if(i<80){
          ...
          light_color_green_left(x,y)
          points(x[i-20], y[100],pch=16, col="red", cex=2)
        }
      }
      ...
      if(direction_to == "NORTH"){
        ...
        if(i<90){
          ...
          light_color_red_left(x,y)
          points(x[105], y[i+14 ],pch=16, col="red", cex=2)
          Sys.sleep(0.3)
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[105], y[i+14 ],pch=16, col="red", cex=2)
      ...
      if(direction_to == "SOUTH"){
        ...
        if(i<85){
          ...
          light_color_red_left(x,y)
          points(x[115], y[105],pch=16, col="red", cex=2)
          Sys.sleep(0.3)
        }else if(i>140){
          light_color_green_left(x,y)
          if(i<=145){
            points(x[250-i], y[105],pch=16, col="red", cex=2)
          }else{
            points(x[100], y[250-i],pch=16, col="red", cex=2)
          }
        }
      }
    ...
    for(i in 1:simulation_time){
      ...
      if(direction_to == "WEST"){
        ...
        if(i<90){
          ...
          light_color_red_left(x,y)
          points(x[i+10], y[100],pch=16, col="red", cex=2)
          Sys.sleep(0.3)
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[i+10], y[100 ],pch=16, col="red", cex=2)
      ...
      if(direction_to == "WEST"){
        ...
        if(i<90){
          ...
          if(i<=100){
            ...
            points(x[i+4], y[100],pch=16, col="red", cex=2)
          }
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[i+4], y[100],pch=16, col="red", cex=2)
    ...
    for(i in 1:simulation_time){
      ...
      if(direction_to == "WEST"){
        ...
        if(i<90){
          ...
          light_color_green_left(x,y)
          points(x[i-56], y[100],pch=18, col="red", cex=2)
        }
      }
    ...
    for(i in 1:simulation_time){
      ...
      if(direction_to == "EAST"){
        ...
        if(i<80){
          ...
          light_color_red_left(x,y)
          points(x[120], y[105],pch=18, col="red", cex=2)
          Sys.sleep(0.6)
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[140-(i-120)], y[105],pch=18, col="red", cex=2)
        }
      }
      ...
      if(direction_to == "WEST"){
        ...
        if(i<80){
          ...
          light_color_green_left(x,y)
          points(x[i-20], y[100],pch=18, col="red", cex=2)
        }
      }
      ...
      if(direction_to == "NORTH"){
        ...
        if(i<90){
          ...
          light_color_red_left(x,y)
          points(x[105], y[i+14 ],pch=18, col="red", cex=2)
          Sys.sleep(0.6)
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[105], y[i+14 ],pch=18, col="red", cex=2)
      ...
      if(direction_to == "SOUTH"){
        ...
        if(i<85){
          ...
          light_color_red_left(x,y)
          points(x[115], y[105],pch=18, col="red", cex=2)
          Sys.sleep(0.6)
        }else if(i>140){
          light_color_green_left(x,y)
          if(i<=145){
            points(x[250-i], y[105],pch=18, col="red", cex=2)
          }else{
            points(x[100], y[250-i],pch=18, col="red", cex=2)
          }
        }
      }
    ...
    for(i in 1:simulation_time){
      ...
      if(direction_to == "WEST"){
        ...
        if(i<90){
          ...
          light_color_red_left(x,y)
          points(x[i+10], y[100],pch=18, col="red", cex=2)
          Sys.sleep(0.6)
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[i+10], y[100 ],pch=18, col="red", cex=2)
      ...
      if(direction_to == "WEST"){
        ...
        if(i<90){
          ...
          if(i<=100){
            ...
            points(x[i+4], y[100],pch=18, col="red", cex=2)
          }
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[i+4], y[100],pch=18, col="red", cex=2)
    ...
    for(i in 1:simulation_time){
      ...
      if(direction_to == "WEST"){
        ...
        if(i<90){
          ...
          light_color_green_left(x,y)
          points(x[i-56], y[100],pch=15, col="red", cex=2)
        }
      }
    ...
    for(i in 1:simulation_time){
      ...
      if(direction_to == "EAST"){
        ...
        if(i<80){
          ...
          light_color_red_left(x,y)
          points(x[120], y[105],pch=15, col="red", cex=2)
          Sys.sleep(1)
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[140-(i-120)], y[105],pch=15, col="red", cex=2)
        }
      }
      ...
      if(direction_to == "WEST"){
        ...
        if(i<80){
          ...
          light_color_green_left(x,y)
          points(x[i-20], y[100],pch=15, col="red", cex=2)
        }
      }
      ...
      if(direction_to == "NORTH"){
        ...
        if(i<90){
          ...
          light_color_red_left(x,y)
          points(x[105], y[i+14 ],pch=15, col="red", cex=2)
          Sys.sleep(1)
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[105], y[i+14 ],pch=15, col="red", cex=2)
      ...
      if(direction_to == "SOUTH"){
        ...
        if(i<85){
          ...
          light_color_red_left(x,y)
          points(x[115], y[105],pch=15, col="red", cex=2)
          Sys.sleep(1)
        }else if(i>140){
          light_color_green_left(x,y)
          if(i<=145){
            points(x[250-i], y[105],pch=15, col="red", cex=2)
          }else{
            points(x[100], y[250-i],pch=15, col="red", cex=2)
          }
        }
      }
    ...
    for(i in 1:simulation_time){
      ...
      if(direction_to == "WEST"){
        ...
        if(i<90){
          ...
          light_color_red_left(x,y)
          points(x[i+10], y[100],pch=15, col="red", cex=2)
          Sys.sleep(1)
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[i+10], y[100 ],pch=15, col="red", cex=2)
      ...
      if(direction_to == "WEST"){
        ...
        if(i<90){
          ...
          if(i<=100){
            ...
            points(x[i+4], y[100],pch=15, col="red", cex=2)
          }
        }else if(i>140){
          light_color_green_left(x,y)
          points(x[i+4], y[100],pch=15, col="red", cex=2)
